...
@section("content")
    ...
    <form action="{{ route('fixturesByDate') }}" method="get">
        @csrf
        
          <div class="form-group row">
            <label for="date-input" class="col-2 col-form-label">Choose Date</label>
            <div class="col-10">
              <input class="form-control" type="date"name="datec" value="{{date($date_format, strtotime($date))}}">
            </div>
          </div>
            <input class="btn btn-primary btn-lg text-right" type="submit" value="ok">
        </form>
<br>
